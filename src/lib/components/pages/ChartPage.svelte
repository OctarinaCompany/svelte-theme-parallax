<script lang="ts">
	 ...
	 *
	 * THE ACTIVE LINK CARRIES THE HOUSE MARK, not the reference's underline — 6px of `primary`
	 ...
	 * exactly the curve the house cut refuses; and `box-sizing: border-box` means 6px of border
	 * would eat 5px of a link whose height is fixed by the 60px header, lifting the label off
	 ...
	 * outer edge, spending 1px over the rule and 5px growing up into the button. It is the same
	 ...
	 */
	const cardTab =
		"relative flex h-full items-center text-xs transition-colors text-muted-foreground after:absolute after:inset-x-0 after:-bottom-px after:h-1.5 after:rounded-t-md after:transition-colors hover:text-foreground";
