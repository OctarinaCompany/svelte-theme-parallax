	...
	export const sidebarMenuButtonVariants = tv({
		...
		variants: {
			variant: {
				...
				outline:
					"bg-background shadow-[0_0_0_1px_var(--sidebar-outline)] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_var(--sidebar-accent)]",
			},
			size: {
				default: "h-8 text-sm",
				sm: "h-7 text-xs",
