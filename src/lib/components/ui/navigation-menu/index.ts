...
// Local divergence from the upstream barrel: the trigger's style recipe is re-exported so
// link-only entries can borrow it without a deep import into the trigger file.
